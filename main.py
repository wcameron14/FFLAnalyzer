...
database.create_table(conn, cur, 'League_owners', "league_id VARCHAR, display_name VARCHAR, user_id VARCHAR, is_owner boolean, PRIMARY KEY (league_id, user_id)")
database.create_table(conn, cur, 'Team_Name', "user_id VARCHAR PRIMARY KEY, display_name VARCHAR, league_id VARCHAR, team_name VARCHAR")
