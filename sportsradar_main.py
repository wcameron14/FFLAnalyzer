...
database.create_sportsradar_table(conn, cur, 'nfl_schedules',"schedule_id TEXT, year INTEGER, schedule_type TEXT, schedule_name TEXT, week_id TEXT, sequence INTEGER, game_id TEXT, home_name TEXT, away_name TEXT, PRIMARY KEY ( schedule_id, week_id, game_id)")
database.create_table(conn, cur, 'game_rushing_stats', "game_id TEXT, player_id TEXT, first_downs INTEGER, rush_avg_yards FLOAT, rush_attempts INTEGER, rush_touchdowns INTEGER, rush_yards INTEGER, rush_longest INTEGER, rush_redzone_attempts INTEGER, tlost INTEGER, tlost_yards INTEGER, broken_tackles INTEGER, kneel_downs INTEGER, scrambles INTEGER, yards_after_contact INTEGER, PRIMARY KEY (game_id, player_id)")
